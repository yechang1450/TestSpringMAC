...
<script>
    layui.use('table', function(){
        ...
        function page() {
            jQuery.ajax({
                url: 'consumptionRecord/selectCount',
                dataType: 'json',
                type: 'get',
                async:false,
        ...
        table.render({
            elem: '#test'
            ,url:'http://localhost:8080/consumptionRecord/findUserConsumptionRecord'
            ,toolbar: '#toolbarDemo'
            ,cols: [[
                {type:'radio'}
                ,{field:'id', width:150, title: 'ID', sort: true}
                ,{field:'userName', width:150, title: '用户名'}
                ,{field:'consumption', width:150, title: '消费金额', sort: true}
                ,{field:'consumption_time', width:300, title: '消费时间'}
                ,{field:'consumption_detail', width:300, title: '消费详情'}
            ]]
            , id: 'testReload'
            ,page: true
            , limit: 5
